...
set cbr_size 1000
set cbr_rate 11.0Mb
set kkk [lindex $argv 4]
#set ind [expr $start_time+$time_duration/2]
set cbr_interval [expr 1.0/$kkk];# ?????? 1 for 1 packets per second and 0.1 for 10 packets per second
...
set tr /home/mritunjoy/ubuntu/ns2\ programs/raw_data/tcp_wireless.tr
...
set topofile [open topo_tcp_wireless.txt "w"]
